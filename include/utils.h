...
/**
  * @brief Implements deallocation for the 2D board.
  *
  * Checks if BOARD is nullptr.
  * Iterates through each row and deallocates using delete[].
  * Deallocates the array of row pointers using delete[].
  * Sets BOARD to nullptr to avoid dangling pointers.
  *
  * @param BOARD A 9x9 Sudoku board.
  * @param rows number of rows in Sudoku board.
  */
